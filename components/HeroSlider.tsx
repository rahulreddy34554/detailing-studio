...
export function WhyChooseUs() {
  ...
  // Separate hover state for each feature
          ...
          <div className="space-y-4 mb-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="text-3xl font-bold text-transparent cursor-pointer"
                style={{
                  WebkitTextStroke: hoveredIndex === index ? "1.5px red" : "2px gray",
